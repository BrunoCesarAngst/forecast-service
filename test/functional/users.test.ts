...
describe('User functional test', () => {
  ...
  describe('Whe authenticating a user', () => {
    ...
    it('should return UNAUTHENTICATED if the user with the given email is not found', async () => {
      const response = await global.testRequest
        .post('/users/authenticate')
        .send({ email: 'some-foo@bar.com', password: '1234' });
